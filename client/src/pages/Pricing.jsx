...
import { Check, X, Zap, Shield, Crown, Star, ArrowRight, HelpCircle } from 'lucide-react';
...
function Pricing() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "We accept all major credit cards, PayPal, and wire transfers for annual plans. Enterprise clients can also use purchase orders."
    },
    {
      question: "Is there a free trial?",
      answer: "Yes! All plans come with a 14-day free trial. No credit card required to start. You can test all features before committing."
    },
    {
      question: "What happens if I exceed my intersection limit?",
      answer: "We'll notify you when you're approaching your limit. You can easily upgrade to the next tier or purchase additional intersection packs."
    },
    {
      question: "Do you offer custom enterprise solutions?",
      answer: "Absolutely! For large deployments, we can create custom packages with tailored features, pricing, and dedicated support. Contact our sales team."
    },
    {
      question: "What's included in the setup process?",
      answer: "All plans include initial setup assistance. Professional and Enterprise plans include comprehensive onboarding, data migration, and staff training."
    }
  ];
        ...
        <div className="container relative mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Scale your traffic management from a single intersection to an entire city. 
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    <div className="text-center mb-6">
                      <div className={`inline-flex p-4 bg-gradient-to-br ${colors.gradient} rounded-xl mb-4`}>
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center gap-2 px-6 py-4 bg-gradient-to-r from-violet-50 to-purple-50 rounded-xl border border-violet-200">
              ...
              <span className="text-gray-700">
                ...
                <a href="/contact" className="ml-2 text-violet-600 font-semibold hover:text-violet-700">
