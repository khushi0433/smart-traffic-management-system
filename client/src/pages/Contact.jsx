      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500/10 to-emerald-500/10 rounded-full mb-6 backdrop-blur-sm border border-blue-200/50">
              <span className="text-sm font-semibold bg-gradient-to-r from-blue-600 to-emerald-500 bg-clip-text text-transparent">
                CONTACT OUR TEAM
              </span>
            </div>
